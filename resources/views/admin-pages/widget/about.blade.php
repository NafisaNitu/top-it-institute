    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="nav-icon fas fa-th-large "></i> Widget</h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            @if(isset($about))
                                <form action="{{route('admin.update.widget.about',['id'=>$about->id])}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                            @else
                                <form action="{{route('admin.create.widget.about')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                            @endif
